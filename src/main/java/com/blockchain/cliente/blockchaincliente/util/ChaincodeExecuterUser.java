...
public class ChaincodeExecuterUser implements ChaincodeExecuter<UserIdentity> {
    ...
    public String executeTransaction(boolean invoke, String func, String[] args) throws InvalidArgumentException, ProposalException {
        ...
        Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.INFO, String.format(
        ...
        for (ProposalResponse response : proposalResponses) {
            ...
            if (response.getStatus() == ChaincodeResponse.Status.SUCCESS) {
                ...
                Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.SEVERE, String.format(
        ...
        if (invoke) {
            Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.INFO, "Send transaction to orderer...");
            ...
            try {
                ...
                if (future.isDone()) {
                    Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.INFO, "Orderer response: txid: " + transactionEvent.getTransactionID());
                    Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.INFO, "Orderer response: block number: " + transactionEvent.getBlockEvent().getBlockNumber());
                    return payload;
                }
            } catch (InterruptedException | ExecutionException ex) {
                Logger.getLogger(ChaincodeExecuterUser.class.getName()).log(Level.SEVERE, "Orderer exception happened: " + ex);
                return null;
            }
        }
    ...
    public String save(String key, UserIdentity userID) {
